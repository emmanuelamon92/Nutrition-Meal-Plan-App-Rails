...
profile = Profile.create([
    {name: 'Tim Burn', age: 32, current_weight: 143, target_weight: 160, user_id: rand(user_ids.first...user_ids.last) },
    {name: 'Carry Bill', age: 25, current_weight: 140, target_weight: 125, user_id: rand(user_ids.first...user_ids.last) }
])
